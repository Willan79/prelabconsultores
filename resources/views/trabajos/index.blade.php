...
@section('contenido')
    <div class="p-2 rounded shadow-lg">
        ...
        <p class="text-center text-muted fs-5">Explora los trabajos realizados para nuestros clientes y conoce más sobre nuestra
            experiencia.</p>
        <hr class="mb-4">
                ...
                @foreach ($trabajos as $trabajo)
                    <div class="col-md-6">
                        <div class="card rounded shadow-lg h-100">
                            ...
                            {{-- Imagen del trabajo --}}
                            @if ($trabajo->imagens->isNotEmpty()) {{--- Si hay imágenes asociadas al trabajo --}}
